...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-line bg-white/86 shadow-sm backdrop-blur-xl">
      <Container className="flex min-h-16 items-center justify-between gap-4 py-3">
        ...
        <nav className="flex items-center gap-2 sm:gap-4" aria-label="Main navigation">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 rounded-md bg-ink px-3 py-2 text-sm font-bold text-white shadow-sm transition hover:bg-teal focus:outline-none focus-visible:ring-2 focus-visible:ring-teal focus-visible:ring-offset-2"
          >
            Explore
